 ...
 * ```
 */
class PReLU extends _Layer2.default {
  /**
  ...
  constructor(attrs = {}) {
    ...
    // GPU setup
    if (this.gpu) {
      this.program = _WebGL.webgl2.compileProgram(require('./PReLU.glsl'));
    }
  }
  ...
  _callGPU(x) {
    ...
    _WebGL.webgl2.runProgram({
      ...
      output: this.output,
      inputs: [{ texture: x.glTexture, type: '2d', name: 'x' }, { texture: this.weights['alpha'].glTexture, type: '2d', name: 'alpha' }]
    });
