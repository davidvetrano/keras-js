 ...
 */
class Cropping3D extends _Layer2.default {
  /**
  ...
  _callCPU(x) {
    ...
    _ndarrayOps2.default.assign(this.output.tensor, x.tensor.hi(this.inputShape[0] - this.cropping[0][1], this.inputShape[1] - this.cropping[1][1], this.inputShape[2] - this.cropping[2][1], this.inputShape[3]).lo(this.cropping[0][0], this.cropping[1][0], this.cropping[2][0], 0));
